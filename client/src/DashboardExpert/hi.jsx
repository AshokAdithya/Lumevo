...
function ExpertPage() {
  ...
  const [selectedType, setSelectedType] = useState("all"); // Add selectedType state
  // const { orders, loading, error, filters, page, limit, total } = useSelector(
  //   (state) => state.orders
  // );
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await axios.post(`${server}api/get/expert/orders`);
